...
echo ""
echo "🚀 准备部署 zk_invoice_v4_1.aleo"
echo "   网络           : $NETWORK"
echo "   节点           : $ENDPOINT"
...
echo ""
echo "🎉 部署完成！Program ID: zk_invoice_v4_1.aleo"
echo ""
echo "📝 请在项目根目录 .env.local 中更新："
echo "   NEXT_PUBLIC_INVOICE_V4_PROGRAM_ID=zk_invoice_v4_1.aleo"
echo ""
