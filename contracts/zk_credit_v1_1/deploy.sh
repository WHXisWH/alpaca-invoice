...
# leo 3.5.0 起，provable.com/v1 可直接用于 build + deploy + broadcast
# aleo.org 已永久迁移至 provable.com（leo deploy 会给出 301 提示）
ENDPOINT="https://api.explorer.provable.com/v1"

echo ""
echo "🚀 准备部署 zk_credit_v1_1.aleo"
echo "   网络           : $NETWORK"
echo "   节点           : $ENDPOINT"
...
echo ""
echo "🎉 部署完成！Program ID: zk_credit_v1_1.aleo"
echo ""
echo "📝 请在项目根目录 .env.local 中更新："
echo "   NEXT_PUBLIC_CREDIT_PROGRAM_ID=zk_credit_v1_1.aleo"
echo ""
