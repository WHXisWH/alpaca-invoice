...
export const PROGRAM_ID_V4 = process.env.NEXT_PUBLIC_PROGRAM_ID_V4 ?? 'zk_invoice_v4.aleo';

/** ZK Credit Proof standalone contract */
export const CREDIT_PROGRAM_ID = process.env.NEXT_PUBLIC_CREDIT_PROGRAM_ID ?? 'zk_credit_v1.aleo';
